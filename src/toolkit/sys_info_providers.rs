...
use crate::toolkit::sys_info::windows;

#[cfg(target_os = "linux")]
use crate::toolkit::sys_info::linux;
...
use crate::toolkit::sys_info::fallback;
...
impl PlatformProvider for WindowsPlatform {
    ...
    fn get_all_monitors() -> Vec<String> { crate::toolkit::monitors::get_all_monitors() }
}
