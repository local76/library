...
//!
//! In rcommon 4.1 these effects are migrating here from `rIdle-scenes/` (now
...
//! screen-saver runtime (also moving to rcommon in a later 4.x release).
//!
//! All 10 submodules are gated behind `feature = "scenes"`. rcommon's default
...
//! let mut grid = vec![rcommon::core::TerminalCell::default(); 80 * 24];
